...
@section('contenido')
<h1>MOSTRAR</h1>
<form class="row g-3 needs-validation" method="POST" action="/purchases/{{$purchases->id}}" novalidate>
  @csrf  
  @method('DELETE')
  <div class="col-md-12">
    <label for="validationCustom01" class="form-label">User id</label>
    <input type="text" class="form-control" id="validationCustom01" name="name" value="{{$purchases->user_id}}" required>
  ...
  <div class="col-md-12">
    ...
    <input type="text" class="form-control" id="validationCustom02" value="{{$purchases->total_amount}}" name="email" required>
    <div class="valid-feedback">
      Looks good!
    </div>
    <div class="invalid-feedback">
