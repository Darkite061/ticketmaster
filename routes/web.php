...
use \app\Http\Controllers\CategoriyConttoller;
...
// Route::get('/categories/create',[categoriesController::class , 'crear']);
// Route::post('/categories',[categoriesController::class,'guardar']);
// Route::get('/categories/editar/{id}',[categoriesController::class,'editar']);
// Route::put('/categoriesss/{id}',[categoriesController::class,'actualizar']);
