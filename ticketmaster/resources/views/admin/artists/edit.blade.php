...
@section('contenido')
<h1>EDITAR</h1>
<form class="row g-3 needs-validation" method="POST" action="/artist/{{$artists->id}}" novalidate enctype="multipart/form-data">
  @csrf  
  @method('PUT')
  <div class="col-md-12">
  ...
  <div class="col-md-12">
    ...
    <img src="{{ $artists->image }}" alt="{{ $artists->image }}" width="150">
